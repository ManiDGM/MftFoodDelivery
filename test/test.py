...
CustomerController.save("ahmaaaad","messbjah","A@A54.com","jA123")
...
#print(FoodOrderController.save(16, True, datetime.now(), 158.55528))
...
print(OrderMenuItemController.save(11,8,10))